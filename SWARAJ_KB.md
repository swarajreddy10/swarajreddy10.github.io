...
> Reference file for AI tools, recruiters, and collaborators. Last updated: July 2026.
...
### StageWay — Built to enterprise standards
...
### Backend
Node.js (Express), FastAPI, Spring Boot, REST APIs, Microservices, JWT/OAuth2

### Databases
PostgreSQL, MongoDB, JPA/Hibernate, Flyway, indexing and query optimisation

### DevOps & Cloud
Git/GitHub, Docker, GitHub Actions, CI/CD, AWS (EC2, S3, IAM, CloudWatch, Cognito, Bedrock)
