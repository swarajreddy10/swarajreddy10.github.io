    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
                <a href="#top">
                    <Image src={isDarkMode ? assets.logo2 : assets.logo_light} alt='Website logo' className='w-40 h-auto cursor-pointer mr-14' />
                </a>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <button className='block md:hidden ml-3 flex items-center justify-center p-2' onClick={openMenu}>
